...
Este corte corresponde a la release estable **Regression 1.12.3 (41)**. La custodia v3 conserva
la identidad persistente del volumen además del inode y migra de forma acotada los recibos v2
que macOS renumeró al reiniciar, sin mover ni reenumerar la biblioteca. **v1.11.0 (37)** es su
...
1.12.3 (41) contiene un catálogo compilado de hashes, tamaños y permisos para el wrapper
