...
> **Contrato actual del código fuente:** Regression **1.12.6 (44)** y SQLite **v17**.
> **v1.12.6 (44)** es la release estable actual y **v1.11.0 (37)** el baseline histórico. Los documentos de
