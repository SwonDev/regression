...
> **Contrato actual del código fuente:** Regression **1.12.14 (52)** y SQLite **v17**.
> **v1.12.14 (52)** es la release estable actual y **v1.11.0 (37)** el baseline histórico. Los documentos de
