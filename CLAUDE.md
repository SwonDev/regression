...
> **Contrato del checkout:** Regression **1.12.9 (47)**, release estable publicada, y SQLite **v17**.
...
- **Release estable**: v1.12.9 (47), instalada y verificada en `/Applications/Regression.app`
  (`verify-public-installed-state.sh --release-1.12.9`). Baseline histórico: v1.11.0 (37).
